...
class MultiMa_v3(IStrategy):
    ...
    buy_params = {'buy_ma_count': 1, 'buy_ma_gap': 13}
    sell_params = {'sell_ma_count': 20, 'sell_ma_gap': 84}
    minimal_roi = {'0': 0.523, '1553': 0.123, '2332': 0.076, '3169': 0.0, '388': 0.123, '583': 0.076, '792': 0.0}
    stoploss = -0.21
    trailing_stop = False
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=1, space='buy')
    buy_ma_gap = IntParameter(1, gap_max, default=13, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=20, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=84, space='sell')
