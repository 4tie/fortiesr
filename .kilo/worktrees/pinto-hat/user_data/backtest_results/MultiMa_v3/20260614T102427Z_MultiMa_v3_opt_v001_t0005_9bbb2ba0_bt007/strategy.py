...
class MultiMa_v3(IStrategy):
    ...
    buy_params = {'buy_ma_count': 7, 'buy_ma_gap': 12}
    sell_params = {'sell_ma_count': 11, 'sell_ma_gap': 70}
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=12, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=11, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=70, space='sell')
