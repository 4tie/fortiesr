...
class MultiMa_v3(IStrategy):
    ...
    buy_params = {'buy_ma_count': 7, 'buy_ma_gap': 17}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 95}
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=17, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=15, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=95, space='sell')
