...
class MultiMa_v3(IStrategy):
    ...
    buy_params = {'buy_ma_count': 9, 'buy_ma_gap': 8}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 79}
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=9, space='buy')
    buy_ma_gap = IntParameter(1, gap_max, default=8, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=15, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=79, space='sell')
