...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 3, 'buy_ma_gap': 5}
    sell_params = {'sell_ma_count': 2, 'sell_ma_gap': 114}
    ...
    sell_ma_count = IntParameter(1, count_max, default=2, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=114, space='sell')
