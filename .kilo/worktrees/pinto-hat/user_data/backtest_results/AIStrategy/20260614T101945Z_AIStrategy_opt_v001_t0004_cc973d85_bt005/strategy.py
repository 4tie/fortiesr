...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 10, 'buy_ma_gap': 8}
    sell_params = {'sell_ma_count': 8, 'sell_ma_gap': 126}
    ...
    sell_ma_count = IntParameter(1, count_max, default=8, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=126, space='sell')
