...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 10, 'buy_ma_gap': 4}
    sell_params = {'sell_ma_count': 11, 'sell_ma_gap': 125}
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=10, space='buy')
    buy_ma_gap = IntParameter(1, gap_max, default=4, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=11, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=125, space='sell')
