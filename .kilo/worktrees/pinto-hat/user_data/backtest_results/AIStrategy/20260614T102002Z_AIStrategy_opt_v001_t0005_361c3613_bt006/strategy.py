...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 12, 'buy_ma_gap': 12}
    sell_params = {'sell_ma_count': 9, 'sell_ma_gap': 83}
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=12, space='buy')
    buy_ma_gap = IntParameter(1, gap_max, default=12, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=9, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=83, space='sell')
