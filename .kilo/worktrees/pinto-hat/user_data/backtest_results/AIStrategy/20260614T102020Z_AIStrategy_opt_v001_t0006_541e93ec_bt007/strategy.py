...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 8, 'buy_ma_gap': 11}
    sell_params = {'sell_ma_count': 12, 'sell_ma_gap': 103}
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=11, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=12, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=103, space='sell')
