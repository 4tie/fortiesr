...
// index 2 = Portfolio Baseline Backtest, index 3 = Standard Hyperopt, etc.
export const EVENT_TYPE_TO_STAGE_INDEX = {
  ...
  // Stage 3 (Standard Hyperopt) — index 3
  "hyperopt_epoch": 3,
  "sensitivity_result": 3,

  // Stage 4 (Robustness Testing) — index 4
  ...
  // Legacy/disabled event types (kept for backward compatibility with saved runs)
  "regime_detected": 1,  // Regime Detection disabled
  "phase1_self_heal": 1,  // Self-healing disabled
  "wfa_segment_result": 3,  // WFO disabled
  "self_heal_retry": 3,  // Self-healing disabled
};
