...
export const PIPELINE_STEPS = [
  ...
  {
    id: "hyperopt",
    name: "Standard Hyperopt",
    icon: "tune",
    description: "Optimizes strategy parameters using Standard Hyperopt on the In-Sample range",
    whyItMatters: "Finds the best parameter combinations for the selected time range",
    inputs: ["Baseline results", "Parameter spaces", "Optimization epochs"],
    checks: ["Convergence testing", "Parameter stability", "Sensitivity analysis"],
  ...
  },
  {
    ...
    icon: "shield",
    description: "Tests strategy resilience with real fees and slippage scenarios",
    whyItMatters: "Ensures strategy performs well under realistic execution conditions",
    inputs: ["Optimized parameters", "Market scenarios", "Risk thresholds"],
    checks: ["Fee stress testing", "Slippage degradation", "Weakness classification"],
    metrics: ["Profit retention", "Drawdown change", "Weakness score"],
    statusMap: {
      "running": "running",
      "passed": "passed",
      "failed": "failed",
