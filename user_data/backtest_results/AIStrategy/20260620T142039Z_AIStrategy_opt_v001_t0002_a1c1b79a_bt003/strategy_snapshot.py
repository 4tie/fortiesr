...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 6, 'buy_ma_gap': 34}
    sell_params = {'sell_ma_count': 6, 'sell_ma_gap': 35}
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=34, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=6, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=35, space='sell')
