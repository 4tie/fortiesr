...
class MultiMa_v2(IStrategy):
    ...
    buy_params = {'buy_ma_count': 2, 'buy_ma_gap': 12}
    sell_params = {'sell_ma_count': 14, 'sell_ma_gap': 94}
    minimal_roi = {'0': 0.523, '1553': 0.123, '2332': 0.076, '3169': 0.0, '776': 0.123, '1166': 0.076, '1584': 0.0}
    stoploss = -0.345
    trailing_stop = False
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=2, space='buy')
