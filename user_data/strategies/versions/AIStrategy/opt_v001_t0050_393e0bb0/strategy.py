...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 8, 'buy_ma_gap': 52}
    sell_params = {'sell_ma_count': 13, 'sell_ma_gap': 72}
    minimal_roi = {'0': 0.219, '1553': 0.021, '2332': 0.009, '3169': 0.003, '12': 0.214, '33': 0.066, '145': 0.058}
    stoploss = -0.2
    trailing_stop = False
