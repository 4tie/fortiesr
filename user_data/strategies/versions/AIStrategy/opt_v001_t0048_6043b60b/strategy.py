...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 37}
    sell_params = {'sell_ma_count': 10, 'sell_ma_gap': 85}
    minimal_roi = {'0': 0.15, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.117, '33': 0.023, '145': 0.012}
    stoploss = -0.33
    trailing_stop = False
