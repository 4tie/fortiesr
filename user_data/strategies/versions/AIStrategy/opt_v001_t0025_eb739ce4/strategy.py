...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 11, 'buy_ma_gap': 54}
    sell_params = {'sell_ma_count': 6, 'sell_ma_gap': 63}
    minimal_roi = {'0': 0.09, '1553': 0.003, '2332': 0.002, '3169': 0.001, '12': 0.027, '33': 0.019, '145': 0.007}
    stoploss = -0.34
    trailing_stop = False
