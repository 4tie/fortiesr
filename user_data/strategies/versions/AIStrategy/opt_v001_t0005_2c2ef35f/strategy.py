...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 17, 'buy_ma_gap': 67}
    sell_params = {'sell_ma_count': 7, 'sell_ma_gap': 71}
    minimal_roi = {'0': 0.299, '1553': 0.005, '2332': 0.002, '3169': 0.001, '12': 0.099, '33': 0.011, '145': 0.008}
    stoploss = -0.34
    trailing_stop = False
