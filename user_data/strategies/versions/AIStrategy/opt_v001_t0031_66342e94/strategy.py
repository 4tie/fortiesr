...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 14, 'buy_ma_gap': 77}
    sell_params = {'sell_ma_count': 12, 'sell_ma_gap': 54}
    minimal_roi = {'0': 0.023, '1553': 0.006, '2332': 0.002, '3169': 0.002, '12': 0.023, '33': 0.021, '145': 0.006}
    stoploss = -0.24
    trailing_stop = True
