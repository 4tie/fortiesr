...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 7, 'buy_ma_gap': 53}
    sell_params = {'sell_ma_count': 18, 'sell_ma_gap': 54}
    minimal_roi = {'0': 0.102, '1553': 0.002, '2332': 0.001, '3169': 0.001, '12': 0.048, '33': 0.036, '145': 0.002}
    stoploss = -0.16
    trailing_stop = True
