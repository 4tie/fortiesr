...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 15, 'buy_ma_gap': 46}
    sell_params = {'sell_ma_count': 9, 'sell_ma_gap': 77}
    minimal_roi = {'0': 0.147, '1553': 0.011, '2332': 0.001, '3169': 0.001, '12': 0.073, '33': 0.036, '145': 0.016}
    stoploss = -0.16
    trailing_stop = False
