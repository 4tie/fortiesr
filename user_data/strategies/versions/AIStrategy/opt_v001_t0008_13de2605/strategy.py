...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 12, 'buy_ma_gap': 35}
    sell_params = {'sell_ma_count': 10, 'sell_ma_gap': 41}
    minimal_roi = {'0': 0.169, '1553': 0.014, '2332': 0.003, '3169': 0.002, '12': 0.151, '33': 0.134, '145': 0.018}
    stoploss = -0.18
    trailing_stop = False
