...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 7, 'buy_ma_gap': 46}
    sell_params = {'sell_ma_count': 16, 'sell_ma_gap': 99}
    minimal_roi = {'0': 0.088, '1553': 0.002, '2332': 0.002, '3169': 0.002, '12': 0.033, '33': 0.003, '145': 0.003}
    stoploss = -0.29
    trailing_stop = False
