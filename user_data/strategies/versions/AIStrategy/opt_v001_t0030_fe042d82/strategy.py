...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 50}
    sell_params = {'sell_ma_count': 16, 'sell_ma_gap': 89}
    minimal_roi = {'0': 0.123, '1553': 0.002, '2332': 0.001, '3169': 0.001, '12': 0.043, '33': 0.023, '145': 0.004}
    stoploss = -0.26
    trailing_stop = False
