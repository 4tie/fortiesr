...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 15, 'buy_ma_gap': 37}
    sell_params = {'sell_ma_count': 10, 'sell_ma_gap': 64}
    minimal_roi = {'0': 0.242, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.052, '33': 0.022, '145': 0.015}
    stoploss = -0.25
    trailing_stop = True
