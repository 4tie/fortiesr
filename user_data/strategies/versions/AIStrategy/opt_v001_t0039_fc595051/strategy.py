...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 10, 'buy_ma_gap': 44}
    sell_params = {'sell_ma_count': 7, 'sell_ma_gap': 92}
    minimal_roi = {'0': 0.098, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.008, '33': 0.003, '145': 0.001}
    stoploss = -0.32
    trailing_stop = False
