...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 12, 'buy_ma_gap': 90}
    sell_params = {'sell_ma_count': 13, 'sell_ma_gap': 96}
    minimal_roi = {'0': 0.289, '1553': 0.002, '2332': 0.002, '3169': 0.002, '12': 0.07, '33': 0.017, '145': 0.012}
    stoploss = -0.32
    trailing_stop = False
