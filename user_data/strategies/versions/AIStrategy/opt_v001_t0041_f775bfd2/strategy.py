...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 13, 'buy_ma_gap': 77}
    sell_params = {'sell_ma_count': 14, 'sell_ma_gap': 39}
    minimal_roi = {'0': 0.221, '1553': 0.027, '2332': 0.008, '3169': 0.004, '12': 0.137, '33': 0.084, '145': 0.031}
    stoploss = -0.25
    trailing_stop = True
