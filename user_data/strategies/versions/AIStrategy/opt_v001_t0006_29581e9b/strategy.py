...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 6, 'buy_ma_gap': 53}
    sell_params = {'sell_ma_count': 13, 'sell_ma_gap': 83}
    minimal_roi = {'0': 0.085, '1553': 0.005, '2332': 0.003, '3169': 0.001, '12': 0.079, '33': 0.031, '145': 0.018}
    stoploss = -0.2
    trailing_stop = True
