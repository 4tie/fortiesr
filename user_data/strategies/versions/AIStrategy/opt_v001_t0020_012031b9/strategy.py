...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 102}
    sell_params = {'sell_ma_count': 18, 'sell_ma_gap': 56}
    minimal_roi = {'0': 0.177, '1553': 0.066, '2332': 0.02, '3169': 0.005, '12': 0.128, '33': 0.088, '145': 0.08}
    stoploss = -0.16
    trailing_stop = False
