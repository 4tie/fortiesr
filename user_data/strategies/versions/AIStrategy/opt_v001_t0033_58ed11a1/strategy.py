...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 15, 'buy_ma_gap': 58}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 44}
    minimal_roi = {'0': 0.254, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.153, '33': 0.134, '145': 0.009}
    stoploss = -0.31
    trailing_stop = False
