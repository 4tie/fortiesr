...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 54}
    sell_params = {'sell_ma_count': 14, 'sell_ma_gap': 79}
    minimal_roi = {'0': 0.277, '1553': 0.077, '2332': 0.071, '3169': 0.003, '12': 0.144, '33': 0.106, '145': 0.096}
    stoploss = -0.33
    trailing_stop = False
