...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 14, 'buy_ma_gap': 39}
    sell_params = {'sell_ma_count': 13, 'sell_ma_gap': 87}
    minimal_roi = {'0': 0.299, '1553': 0.002, '2332': 0.001, '3169': 0.001, '12': 0.033, '33': 0.026, '145': 0.021}
    stoploss = -0.26
    trailing_stop = True
    trailing_stop_positive = 0.062
