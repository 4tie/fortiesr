...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 59}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 53}
    minimal_roi = {'0': 0.252, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.145, '33': 0.021, '145': 0.01}
    stoploss = -0.25
    trailing_stop = False
