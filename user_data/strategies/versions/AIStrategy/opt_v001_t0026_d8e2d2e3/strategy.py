...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 14, 'buy_ma_gap': 61}
    sell_params = {'sell_ma_count': 8, 'sell_ma_gap': 69}
    minimal_roi = {'0': 0.243, '1553': 0.011, '2332': 0.01, '3169': 0.007, '12': 0.069, '33': 0.068, '145': 0.029}
    stoploss = -0.33
    trailing_stop = True
