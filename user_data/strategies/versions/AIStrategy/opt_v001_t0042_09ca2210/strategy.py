...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 9, 'buy_ma_gap': 83}
    sell_params = {'sell_ma_count': 12, 'sell_ma_gap': 98}
    minimal_roi = {'0': 0.016, '1553': 0.002, '2332': 0.002, '3169': 0.002, '12': 0.009, '33': 0.004, '145': 0.003}
    stoploss = -0.26
    trailing_stop = False
