...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 79}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 36}
    minimal_roi = {'0': 0.127, '1553': 0.041, '2332': 0.022, '3169': 0.018, '12': 0.123, '33': 0.117, '145': 0.043}
    stoploss = -0.18
    trailing_stop = True
