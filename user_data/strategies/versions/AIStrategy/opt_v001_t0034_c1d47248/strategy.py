...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 15, 'buy_ma_gap': 47}
    sell_params = {'sell_ma_count': 16, 'sell_ma_gap': 56}
    minimal_roi = {'0': 0.077, '1553': 0.002, '2332': 0.001, '3169': 0.001, '12': 0.047, '33': 0.031, '145': 0.031}
    stoploss = -0.25
    trailing_stop = True
    trailing_stop_positive = 0.072
