...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 12, 'buy_ma_gap': 64}
    sell_params = {'sell_ma_count': 9, 'sell_ma_gap': 39}
    minimal_roi = {'0': 0.256, '1553': 0.02, '2332': 0.005, '3169': 0.004, '12': 0.099, '33': 0.075, '145': 0.048}
    stoploss = -0.3
    trailing_stop = False
