...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 81}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 80}
    minimal_roi = {'0': 0.155, '1553': 0.01, '2332': 0.006, '3169': 0.005, '12': 0.041, '33': 0.036, '145': 0.036}
    stoploss = -0.22
    trailing_stop = True
