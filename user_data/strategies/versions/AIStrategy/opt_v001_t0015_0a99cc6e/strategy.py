...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 14, 'buy_ma_gap': 71}
    sell_params = {'sell_ma_count': 12, 'sell_ma_gap': 44}
    minimal_roi = {'0': 0.027, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.008, '33': 0.002, '145': 0.001}
    stoploss = -0.3
    trailing_stop = True
    trailing_stop_positive = 0.049
