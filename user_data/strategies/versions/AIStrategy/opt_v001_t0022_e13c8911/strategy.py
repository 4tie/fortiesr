...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 18, 'buy_ma_gap': 81}
    sell_params = {'sell_ma_count': 9, 'sell_ma_gap': 53}
    minimal_roi = {'0': 0.228, '1553': 0.004, '2332': 0.003, '3169': 0.001, '12': 0.07, '33': 0.038, '145': 0.004}
    stoploss = -0.17
    trailing_stop = False
