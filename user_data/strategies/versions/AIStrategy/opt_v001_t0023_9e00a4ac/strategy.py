...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 65}
    sell_params = {'sell_ma_count': 16, 'sell_ma_gap': 49}
    minimal_roi = {'0': 0.286, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.023, '33': 0.004, '145': 0.001}
    stoploss = -0.16
    trailing_stop = True
