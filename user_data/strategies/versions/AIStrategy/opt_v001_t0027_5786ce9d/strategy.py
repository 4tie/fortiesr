...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 13, 'buy_ma_gap': 57}
    sell_params = {'sell_ma_count': 7, 'sell_ma_gap': 69}
    minimal_roi = {'0': 0.064, '1553': 0.005, '2332': 0.002, '3169': 0.002, '12': 0.043, '33': 0.042, '145': 0.041}
    stoploss = -0.24
    trailing_stop = False
