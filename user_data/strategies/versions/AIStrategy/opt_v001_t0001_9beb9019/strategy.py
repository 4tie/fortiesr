...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 10, 'buy_ma_gap': 59}
    sell_params = {'sell_ma_count': 17, 'sell_ma_gap': 51}
    minimal_roi = {'0': 0.277, '1553': 0.003, '2332': 0.003, '3169': 0.002, '12': 0.038, '33': 0.003, '145': 0.003}
    stoploss = -0.17
    trailing_stop = True
    trailing_stop_positive = 0.087
