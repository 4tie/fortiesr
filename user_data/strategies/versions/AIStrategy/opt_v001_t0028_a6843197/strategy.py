...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 18, 'buy_ma_gap': 59}
    sell_params = {'sell_ma_count': 16, 'sell_ma_gap': 64}
    minimal_roi = {'0': 0.099, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.002, '33': 0.002, '145': 0.001}
    stoploss = -0.33
    trailing_stop = True
