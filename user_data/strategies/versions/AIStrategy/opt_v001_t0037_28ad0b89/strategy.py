...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 6, 'buy_ma_gap': 59}
    sell_params = {'sell_ma_count': 10, 'sell_ma_gap': 37}
    minimal_roi = {'0': 0.187, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.024, '33': 0.003, '145': 0.001}
    stoploss = -0.23
    trailing_stop = False
