...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 9, 'buy_ma_gap': 79}
    sell_params = {'sell_ma_count': 7, 'sell_ma_gap': 58}
    minimal_roi = {'0': 0.292, '1553': 0.078, '2332': 0.023, '3169': 0.015, '12': 0.224, '33': 0.215, '145': 0.171}
    stoploss = -0.16
    trailing_stop = False
