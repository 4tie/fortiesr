...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 18, 'buy_ma_gap': 69}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 60}
    minimal_roi = {'0': 0.3, '1553': 0.006, '2332': 0.005, '3169': 0.001, '12': 0.124, '33': 0.017, '145': 0.014}
    stoploss = -0.34
    trailing_stop = True
