...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 16, 'buy_ma_gap': 101}
    sell_params = {'sell_ma_count': 18, 'sell_ma_gap': 37}
    minimal_roi = {'0': 0.274, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.164, '33': 0.124, '145': 0.001}
    stoploss = -0.24
    trailing_stop = False
