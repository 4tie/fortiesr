...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 12, 'buy_ma_gap': 102}
    sell_params = {'sell_ma_count': 10, 'sell_ma_gap': 95}
    minimal_roi = {'0': 0.128, '1553': 0.01, '2332': 0.008, '3169': 0.006, '12': 0.034, '33': 0.032, '145': 0.023}
    stoploss = -0.17
    trailing_stop = True
