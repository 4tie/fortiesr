...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 8, 'buy_ma_gap': 58}
    sell_params = {'sell_ma_count': 8, 'sell_ma_gap': 78}
    minimal_roi = {'0': 0.006, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.005, '33': 0.002, '145': 0.001}
    stoploss = -0.25
    trailing_stop = False
