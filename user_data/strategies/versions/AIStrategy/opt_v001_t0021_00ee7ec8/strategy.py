...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 17, 'buy_ma_gap': 40}
    sell_params = {'sell_ma_count': 17, 'sell_ma_gap': 91}
    minimal_roi = {'0': 0.045, '1553': 0.001, '2332': 0.001, '3169': 0.001, '12': 0.005, '33': 0.003, '145': 0.002}
    stoploss = -0.18
    trailing_stop = True
