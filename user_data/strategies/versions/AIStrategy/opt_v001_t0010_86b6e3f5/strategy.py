...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 9, 'buy_ma_gap': 69}
    sell_params = {'sell_ma_count': 7, 'sell_ma_gap': 50}
    minimal_roi = {'0': 0.034, '1553': 0.01, '2332': 0.001, '3169': 0.001, '12': 0.012, '33': 0.011, '145': 0.011}
    stoploss = -0.34
    trailing_stop = True
