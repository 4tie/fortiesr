...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 11, 'buy_ma_gap': 48}
    sell_params = {'sell_ma_count': 18, 'sell_ma_gap': 42}
    minimal_roi = {'0': 0.11, '1553': 0.01, '2332': 0.008, '3169': 0.001, '12': 0.02, '33': 0.018, '145': 0.01}
    stoploss = -0.23
    trailing_stop = False
