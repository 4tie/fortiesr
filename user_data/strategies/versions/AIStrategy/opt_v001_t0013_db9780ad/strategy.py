...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 9, 'buy_ma_gap': 72}
    sell_params = {'sell_ma_count': 11, 'sell_ma_gap': 35}
    minimal_roi = {'0': 0.121, '1553': 0.02, '2332': 0.019, '3169': 0.014, '12': 0.051, '33': 0.03, '145': 0.026}
    stoploss = -0.19
    trailing_stop = False
