...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 17, 'buy_ma_gap': 49}
    sell_params = {'sell_ma_count': 14, 'sell_ma_gap': 88}
    minimal_roi = {'0': 0.167, '1553': 0.047, '2332': 0.021, '3169': 0.006, '12': 0.112, '33': 0.107, '145': 0.073}
    stoploss = -0.27
    trailing_stop = False
