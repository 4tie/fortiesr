...
class Diamond(IStrategy):
    ...
    buy_params = {'buy_fast_key': 'ma_fast', 'buy_horizontal_push': 2, 'buy_slow_key': 'ma_slow', 'buy_vertical_push': 1.94}
    sell_params = {'sell_fast_key': 'ma_fast', 'sell_horizontal_push': 2, 'sell_slow_key': 'ma_slow', 'sell_vertical_push': 1.2}
