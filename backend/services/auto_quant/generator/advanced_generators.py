"""Advanced strategy template generators for the Auto-Quant pipeline.

Produces complex freqtrade strategies with sophisticated features including
omni-strategies with Boolean switches, ensemble voting with weighted consensus,
and advanced position sizing.
"""
